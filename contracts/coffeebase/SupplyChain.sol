    ...
    ConsumerRole
{
    ...
    modifier onlyOwner() {
        require(msg.sender == chain_owner, "Not an Owner!");
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(items[_upc].itemState == State.Purchased, "Not Purchaced");
        _;
    }
    ...
    function kill() public {
        if (msg.sender == chain_owner) {
            selfdestruct(chain_owner);
        }
    }
